...
![Gestion des personnages](./personnages.png)
...
![Configuration des raccourcis](./raccourcis.png)
...
```markdown
![Gestion des personnages](./assets/personnages.png)
```
